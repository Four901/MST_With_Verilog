...
REM
REM Generated by Vivado on Tue Mar 22 09:49:22 +0530 2022
...
echo "xvlog --incr --relax -prj priorityq_tb_vlog.prj"
call xvlog  --incr --relax -prj priorityq_tb_vlog.prj -log xvlog.log
